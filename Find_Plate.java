...
import java.util.ArrayList;
	...
	public class Find_Plate {
		 ...
		 * @throws IOException 
		 */
		public static ArrayList<String[]> FindCarPlate(String InputFileName, Camera_System Cameras, Boolean Test) throws IOException {
		 ...
		 * @throws IOException 
		 */
		public static String[] PlateAlgorithm(Camera_System Cameras, Rect rect, Mat image, String JPGFile) throws IOException {
			...
			Rect rectCrop = new Rect(rect.x - 40, rect.y, rect.width +50, rect.height + 5);
